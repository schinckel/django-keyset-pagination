...
def test_paginator_multiple_pages():
    ...
    assert page.next_page_number() == '["2017-01-01 05:23:45+00:00"]'
    ...
    assert len(page.object_list) == 5
    assert page.next_page_number() == '["2017-01-01 02:23:45+00:00"]'
    page = paginator.page(page.next_page_number())
    assert len(page.object_list) == 1
...
def test_paginator_multiple_ordering_columns():
    ...
    page = paginator.page(1)
    assert page.next_page_number() == '["2017-01-01 01:23:45+00:00", "foo"]'
